...
<div class="w3-bar w3-black w3-hide-small">
  ...
  <a href="#" class="w3-bar-item w3-button">QUIENES SOMOS</a>
  <a href="#" class="w3-bar-item w3-button">PROXIMOS EVENTOS</a>
  <a href="#" class="w3-bar-item w3-button">PREGUNTAS FRECUENTES</a>
  <a href="#" class="w3-bar-item w3-button w3-right" onclick="document.getElementById('subscribe').style.display='block'">REGISTRATE</a>
</div>
...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>MULTILANGUAGE MEETINGS</b></h1>
    <h6>Bienvenido a nueva experiencia sobre el aprendizaje de idiomas</h6>
  </header>

  <!-- Image header -->
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="images/foto2.jpeg" alt="Fashion Blog" width="1600" height="1060">
  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-center">
          <h3>BAR CHUPITOS</h3>
          <h5>INGLES-ESPAÑOL<span class="w3-opacity"> 23 de agosto, 2018</span></h5>
        </div>

        <div class="w3-justify">
          <img src="images/Chupitos-bar-001.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
...
<div id="subscribe" class="w3-modal w3-animate-opacity">
  <div class="w3-modal-content" style="padding:32px">
    <div class="w3-container w3-white">
      <i onclick="document.getElementById('subscribe').style.display='none'" class="w3-transparent w3-button w3-xlarge w3-right">x</i>
      <h2 class="w3-wide">FORMULARIO DE REGISTRO</h2>
      <p>Ingresa tus datos para poder registrarte</p>
      <p><input class="w3-input w3-border" type="email" placeholder="Completa tu e-mail"></p>
      <p><input class="w3-input w3-border" type="text" placeholder="Nombre Completo"></p>
      <p><input class="w3-input w3-border" type="number" placeholder="Edad"></p>
      <p><input class="w3-input w3-border" type="tel" placeholder="Telefono"></p>
      <p><input class="w3-input w3-border" type="text" placeholder="Pais"></p>
      <p><input class="w3-input w3-border" type="text" placeholder="Sexo"></p>
      <p><input class="w3-input w3-border" type="text" placeholder="Idioma"></p>
      <p><input class="w3-input w3-border" type="url" placeholder="Pagina web"></p>
      <p><input class="w3-input w3-border" type="password" placeholder="Clave"></p>
      <button type="button" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom" onclick="document.getElementById('subscribe').style.display='none'">ENVIAR</button>
    </div>
  </div>
</div>
